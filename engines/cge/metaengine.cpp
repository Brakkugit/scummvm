...
Common::KeymapArray CGEMetaEngine::initKeymaps(const char *target) const {
	...
	act = new Action("DEBUG: Set accessible: Location 1 (beginning state)", _("DEBUG: Set accessible: Location 1 (beginning state)"));
	act->setKeyEvent(KeyState(KEYCODE_0, 0, KBD_ALT));
	act->addDefaultInputMapping("A+0");
	keymap->addAction(act);

	// I18N: Sets the current access to Locations 1 to 8.
	act = new Action("DEBUG: Set accessible: Locations 1-8", _("DEBUG: Set accessible: Locations 1-8"));
	act->setKeyEvent(KeyState(KEYCODE_1, 0, KBD_ALT));
	act->addDefaultInputMapping("A+1");
	keymap->addAction(act);

	// I18N: Sets the current access to Locations 1 to 16.
	act = new Action("DEBUG: Set accessible: Locations 1-16", _("DEBUG: Set accessible: Locations 1-16"));
	act->setKeyEvent(KeyState(KEYCODE_2, 0, KBD_ALT));
	act->addDefaultInputMapping("A+2");
	keymap->addAction(act);

	// I18N: Sets the current access to Locations 1 to 23.
	act = new Action("DEBUG: Set accessible: Locations 1-23", _("DEBUG: Set accessible: Locations 1-23"));
	act->setKeyEvent(KeyState(KEYCODE_3, 0, KBD_ALT));
	act->addDefaultInputMapping("A+3");
	keymap->addAction(act);

	// I18N: Sets the current access to Locations 1 to 24.
	act = new Action("DEBUG: Set accessible: Locations 1-24", _("DEBUG: Set accessible: Locations 1-24"));
